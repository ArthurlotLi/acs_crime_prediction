...
propertycsv = 'complete_iterA5_property.csv'
violentcsv = 'complete_iterA5_violent.csv'
...
def build_model(train_dataset):
  ...
  model = keras.Sequential([
    layers.Dense(128, activation=af, input_shape=[len(train_dataset.keys())]),
    layers.Dense(128, activation=af),
