...
propertycsv = 'complete_iterA1_property.csv'
violentcsv = 'complete_iterA1_violent.csv'

def neuralnetwork():
    print("Initializing neuralnetwork() for iteration 1!")
    print(" Attempting to read " +propertycsv+"...")
    datafile = pd.read_csv('dataset/complete/' + propertycsv, index_col = 0) # complete csv file
    print("  ...Done!")
    ...
    sns.pairplot(train_dataset[train_dataset.columns.values.tolist()], diag_kind = "kde")
